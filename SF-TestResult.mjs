...
export function SetVerbose(verboseMode)
{
    verbose = verboseMode;
} // SetVerbose
...
export function gsl_test(status, test_description)
{
    // if (!tests) initialise();

    update( status.Integer );

    if ( (status.Integer != 0) || verbose )
    {
        if ( status.Integer != 0 )
        {
        ...
        process.stdout.write( test_description );
        ...
        if ( status.Integer != 0 )
        {
            process.stdout.write( " (status=" + status.Integer + ")" );
        }
