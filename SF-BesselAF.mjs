...
export const gsl_sf_bessel_amp_phase_bm0_cs = { length: 20, c: bm0_data, order: 20, a: -1.0, b: 1.0, order_sp: 10 };
...
export const gsl_sf_bessel_amp_phase_bth0_cs = { length: 23, c: bth0_data, order: 23, a: -1.0, b: 1.0, order_sp: 12 };
...
export const gsl_sf_bessel_amp_phase_bm1_cs = { length: 20, c: bm1_data, order: 20, a: -1.0, b: 1.0, order_sp: 10 };
...
export const gsl_sf_bessel_amp_phase_bth1_cs = { length: 23, c: bth1_data, order: 23, a: -1.0, b: 1.0, order_sp: 12 };

// ----------------------------------------------------------------------------

export function gsl_sf_bessel_asymp_Mnu_e(nu, x)
{
    var r      = 0.0;
    var s      = 0.0;
    var r2     = 0.0;
    ...
    Mnu2_c = 2.0 / (M_PI) * (1.0 + term1 + term2);
    r = Math.sqrt(Mnu2_c) / Math.sqrt(x); // will never underflow this way
    return r;
...
export function gsl_sf_bessel_asymp_thetanu_corr_e(nu, x)
{
    var r     = 0.0;
    var s     = 0.0;
    var r2    = 0.0;
